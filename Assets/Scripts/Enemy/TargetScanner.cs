...
namespace Gamekit3D
{
    ...
    public class TargetScanner
    {
        ...
        public PlayerController Detect (Transform detector, bool useHeightDifference = true)
        {
            ...
            Vector3 toPlayer = PlayerController._Instance.transform.position - eyePos;
            Vector3 toPlayerTop = PlayerController._Instance.transform.position + Vector3.up * 1.5f - eyePos;
